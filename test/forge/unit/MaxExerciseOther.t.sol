...
contract MaxExerciseOtherTest is Helper {
    ...
    function test_maxExerciseOther_basicFunctionality() public {
        ...
        uint256 maxReferenceAssets = corkPool.maxExerciseOther(defaultCurrencyId, user3);
    ...
    function test_maxExerciseOther_withZeroReferenceBalance() public {
        ...
        uint256 maxReferenceAssets = corkPool.maxExerciseOther(defaultCurrencyId, user2);
    ...
    function test_maxExerciseOther_withZeroAddress() public {
        ...
        uint256 maxReferenceAssets = corkPool.maxExerciseOther(defaultCurrencyId, address(0));
    ...
    function test_maxExerciseOther_integrationWithPreviewExercise() public {
        ...
        (uint256 assets, uint256 otherAssetSpent, uint256 fee) = corkPool.previewExercise(
            defaultCurrencyId,
