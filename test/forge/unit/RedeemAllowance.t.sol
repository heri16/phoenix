...
contract RedeemAllowanceTest is Helper {
    ...
    function setUp() public {
        ...
        corkPool.deposit(defaultCurrencyId, DEPOSIT_AMOUNT, currentCaller());
    ...
    function test_redeemWithSameOwnerSender() public {
        ...
        (uint256 actualPa, uint256 actualRa) = corkPool.redeem(defaultCurrencyId, REDEEM_AMOUNT, owner, receiver);
    ...
    function test_redeemWithInsufficientAllowance() public {
        ...
        vm.startPrank(sender);
        vm.expectRevert();
        corkPool.redeem(defaultCurrencyId, REDEEM_AMOUNT, owner, receiver);
        vm.stopPrank();
    }
    ...
    function test_redeemMultipleReceivers() public {
        ...
        (uint256 actualPa1, uint256 actualRa1) = corkPool.redeem(defaultCurrencyId, REDEEM_AMOUNT / 2, owner, receiver);

        (uint256 actualPa2, uint256 actualRa2) = corkPool.redeem(defaultCurrencyId, REDEEM_AMOUNT / 2, owner, receiver2);
    ...
    function test_maxWithdraw_ownerWithoutShares() public {
        ...
        uint256 maxWithdrawAmount = corkPool.maxWithdraw(defaultCurrencyId, userWithoutShares);
    ...
    function test_maxWithdraw_whenWithdrawalsPaused() public {
        ...
        uint256 maxWithdrawAfterPause = corkPool.maxWithdraw(defaultCurrencyId, owner);
