...
contract CalculateGrossAmountWithTimeDecayFeeTest is Test {
    ...
    function test_calculateGrossAmountWithTimeDecayFee_StartOfPeriod() public pure {
        ...
        (uint256 fee, uint256 assetIn) =
            MathHelper.calculateGrossAmountWithTimeDecayFee(start, end, current, amount, baseFeePercentage);
    ...
    function test_calculateGrossAmountWithTimeDecayFee_minimumFee() public pure {
        uint256 start = 1000;
        uint256 end = 2000;
