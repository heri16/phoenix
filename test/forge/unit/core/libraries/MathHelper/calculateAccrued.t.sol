...
contract CalculateAccruedTest is Test {
    ...
    function test_calculateAccrued_BasicCalculation() public pure {
        ...
        uint256 cptTotalSupply = 1000 ether;
        uint256 expected = 50 ether; // 100 * (500/1000)

        uint256 result = MathHelper.calculateAccrued(amount, available, cptTotalSupply);
    ...
    function test_calculateAccrued_ZeroCptTotalSupply() public pure {
        uint256 amount = 100 ether;
        uint256 available = 500 ether;
        uint256 cptTotalSupply = 0;
        uint256 expected = 0;
