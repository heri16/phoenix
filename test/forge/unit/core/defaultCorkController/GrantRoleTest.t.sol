...
contract GrantRoleTest is BaseTest {
    ...
    address private whitelistManagerAddress;
    ...
    function setUp() public override {
        ...
        whitelistManagerAddress = address(5);

        overridePrank(adminUserAddress);
        defaultCorkController =
            new DefaultCorkController(bob, adminUserAddress, makeAddr("not_used"), whitelistManagerAddress);
    }
    ...
    function test_GrantRole_ShouldWorkCorrectly() public {
        ...
        assertFalse(defaultCorkController.hasRole(role, poolCreator));
    }
