...
contract ExerciseOtherTests is BaseTest {
    ...
    function test_exerciseOther_ShouldWorkWithCompensation() external __as(alice) __deposit(depositAmount, alice) {
        ...
        (uint256 expectedAssets, uint256 expectedOtherSpent, uint256 expectedFee) =
            corkPoolManager.previewExerciseOther(defaultPoolId, exerciseCompensation);
    ...
    function test_exerciseOther_ShouldRevertIfNotEnoughLiquidityForFee()
        external
        __as(alice)
    ...
    function test_exerciseOther_ShouldRevert_WhenCompensationAmountIsZero()
        external
        __as(alice)
    ...
    function test_previewExerciseOther_ShouldReturnAllZeros_WhenZeroCompensation()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        (uint256 assets, uint256 otherAssetSpent, uint256 fee) = corkPoolManager.previewExerciseOther(defaultPoolId, 0);

        assertEq(assets, 0, "Should return 0 assets for zero compensation");
        assertEq(otherAssetSpent, 0, "Should return 0 other asset spent for zero compensation");
        assertEq(fee, 0, "Should return 0 fee for zero compensation");
    }

    function test_previewExerciseOther_ShouldReturnAllZeros_WhenSwapPaused()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
    ...
    function test_previewExerciseOther_ShouldReturnAllZeros_WhenExpired()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
    ...
    function test_exerciseOther_ShouldRevert_WhenInsufficientReferenceAllowance()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
    ...
    function test_exerciseOther_ShouldRevert_WhenInsufficientReferenceBalance()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
    ...
    function test_previewExerciseOther_ShouldReturnCorrectAmounts() external {
        ...
        (uint256 assets, uint256 otherAssetSpent, uint256 fee) =
            corkPoolManager.previewExerciseOther(defaultPoolId, compensation);
    ...
    function test_previewExerciseOther_ShouldReturnSameValueAsPoolManager()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        ...
        (uint256 poolShareAssets, uint256 poolShareOtherAssetSpent, uint256 poolShareFee) =
            PoolShare(swapToken).previewExerciseOther(compensation);

        assertEq(
            poolShareAssets,
            poolManagerAssets,
            "PoolShare previewExerciseOther assets should match PoolManager previewExerciseOther"
        );
        assertEq(
            poolShareOtherAssetSpent,
            poolManagerOtherAssetSpent,
            "PoolShare previewExerciseOther otherAssetSpent should match PoolManager previewExerciseOther"
        );
        assertEq(
            poolShareFee,
            poolManagerFee,
            "PoolShare previewExerciseOther fee should match PoolManager previewExerciseOther"
        );
    }

    // ================================ Max ExerciseOther Tests ================================ //

    function test_maxExerciseOther_ShouldReturnMaxAmountCorrectly()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
    ...
    function test_maxExerciseOther_ShouldReturnSameValueAsPoolManager()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        ...
        assertEq(
            poolShareResult, poolManagerResult, "PoolShare maxExerciseOther should match PoolManager maxExerciseOther"
        );
    }

    function test_maxExerciseOther_ShouldReturnZero_WhenNotInitialized() external __as(alice) {
        MarketId uninitializedPoolId = MarketId.wrap(bytes32("0x123"));

        vm.expectPartialRevert(IErrors.NotInitialized.selector);
        corkPoolManager.maxExerciseOther(uninitializedPoolId, alice);
    }

    function test_maxExerciseOther_ShouldReturnZero_WhenUserHasZeroCST()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        ...
        uint256 maxCompensation = corkPoolManager.maxExerciseOther(defaultPoolId, alice);
        assertEq(maxCompensation, 0, "Should return 0 when user has no cST balance");
    }

    function test_maxExerciseOther_ShouldReturnZero_WhenUserHasZeroReferenceAsset()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        ...
        uint256 maxCompensation = corkPoolManager.maxExerciseOther(defaultPoolId, alice);
        assertEq(maxCompensation, 0, "Should return 0 when user has no reference asset balance");
    }

    // ================================ Different Decimals Tests ================================ //

    function test_exerciseOther_ShouldWorkWith6DecimalCollateral()
        external
    ...
    function test_exerciseOther_ShouldWorkWith6DecimalReference()
        external
        ...
        __as(alice)
    {
        ...
        uint256 normalizedCompensation =
            TransferHelper.normalizeDecimals(exerciseCompensation, TARGET_DECIMALS, referenceDecimal);
        (uint256 assets, uint256 otherAssetSpent, uint256 fee) =
            corkPoolManager.exerciseOther(defaultPoolId, normalizedCompensation, alice);
    ...
    function test_exerciseOther_ShouldWorkWithBoth6Decimals()
        external
    ...
    function test_exerciseOther_ShouldWorkWithMinimumCompensation()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        ...
        (uint256 assets, uint256 otherAssetSpent, uint256 fee) =
            corkPoolManager.exerciseOther(defaultPoolId, minimumCompensation, alice);
    ...
    function test_exerciseOther_PreviewShouldMatchActual() external __as(alice) __deposit(depositAmount, alice) {
        ...
        (uint256 previewAssets, uint256 previewOtherSpent, uint256 previewFee) =
            corkPoolManager.previewExerciseOther(defaultPoolId, testCompensation);
        (uint256 actualAssets, uint256 actualOtherSpent, uint256 actualFee) =
            corkPoolManager.exerciseOther(defaultPoolId, testCompensation, alice);
    ...
    function test_maxExerciseOther_ShouldReturnLimitedShares_WhenUserHasInsufficientReferenceAsset() external {
        ...
        uint256 maxReference = corkPoolManager.maxExerciseOther(defaultPoolId, alice);
    ...
    function test_exerciseOther_ShouldWorkWithDifferentReceiver() external __as(alice) __deposit(depositAmount, alice) {
        ...
        (uint256 assets, uint256 otherAssetSpent, uint256 fee) =
            corkPoolManager.exerciseOther(defaultPoolId, testCompensation, receiver);
    ...
    function testFuzz_exerciseOther(uint8 _collateralDecimal, uint8 _referenceDecimal)
        external
        ...
        __approveAllTokens(bravo, address(corkPoolManager))
    {
        ...
        uint256 exerciseCompensationNormalized =
        ...
        (uint256 assets, uint256 otherAssetSpent, uint256 fee) =
            corkPoolManager.exerciseOther(defaultPoolId, exerciseCompensationNormalized, currentCaller());
        ...
        assertEq(
            _after.contractRef - before.contractRef,
            exerciseCompensationNormalized,
            "Contract should receive reference assets"
        );
    ...
    function testFuzz_previewExerciseOther(uint8 _collateralDecimal, uint8 _referenceDecimal)
        external
        __createPoolBounded(1 days, _collateralDecimal, _referenceDecimal)
        __giveAssets(bravo)
        __approveAllTokens(bravo, address(corkPoolManager))
    {
        ...
        (uint256 actualAssets, uint256 actualOtherSpent, uint256 actualFee) =
            corkPoolManager.exerciseOther(defaultPoolId, compensation, currentCaller());
    ...
    function testFuzz_exerciseOtherShouldNotRevert_WhenUsingMaxExerciseOtherInput(
        ...
        __as(alice)
    {
        ...
        if (lessRef) {
            ...
            // transfer cst so that the balance of cst is half of ref(normalized)
            swapToken.transfer(address(2), cstBalance - toKeep);
        }

        uint256 refIn = corkPoolManager.maxExerciseOther(defaultPoolId, alice);

        // should not revert
        corkPoolManager.exerciseOther(defaultPoolId, refIn, alice);
    }

    function test_maxExerciseOther_ShouldUseOwnerRefBalance_WhenLessThanMaxAccepted()
        external
        __as(alice)
        __deposit(1000 ether, alice)
    {
        uint256 userLimitedRefBalance = 50 ether; // Small amount

        uint256 currentBalance = referenceAsset.balanceOf(alice);
        referenceAsset.transfer(bob, currentBalance - userLimitedRefBalance);

        assertEq(referenceAsset.balanceOf(alice), userLimitedRefBalance, "User should have limited reference balance");

        uint256 maxCompensation = corkPoolManager.maxExerciseOther(defaultPoolId, alice);

        assertEq(
            maxCompensation, userLimitedRefBalance, "Should return user's limited reference balance as the constraint"
        );
        assertGt(userLimitedRefBalance, 0, "Test should have meaningful limited balance");
    }
}
