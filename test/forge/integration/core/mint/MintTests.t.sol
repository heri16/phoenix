...
contract MintTests is BaseTest {
    ...
    function test_mint() public __as(alice) {
...

        {
            ...
            assertEq(
                ...
                initialCollateralBalance - tokensOut,
                "Minter collateral balance should decrease"
            );
            assertEq(
                collateralAsset.balanceOf(address(corkPoolManager)),
                initialCorkPoolBalance + tokensOut,
            ...
            assertEq(
                ...
                initialPrincipalBalance + tokensOut,
            ...
            assertEq(
                ...
                initialPrincipalSupply + tokensOut,
            ...
            assertEq(
                collateralAsset.allowance(alice, address(corkPoolManager)),
                initialAllowance - tokensOut,
    ...
    function test_mintShouldRevertWhenCollateralInIsZero()
        external
        ...
        __approveAllTokens(bravo, address(corkPoolManager))
    {
        ...
        collateralAmountIn = corkPoolManager.mint(defaultPoolId, depositAmount, bravo);
    ...
    function test_previewMint() external __as(bravo) {
    ...
    function testFuzz_mint(uint8 _collateralDecimal, uint8 _referenceDecimal)
        external
        ...
        __approveAllTokens(bravo, address(corkPoolManager))
    {
...

        {
            ...
            assertEq(
                ...
                initialCollateralBalance - mintAmountNormalized,
                "Minter collateral balance should decrease"
            );
            assertEq(
                collateralAsset.balanceOf(address(corkPoolManager)),
                initialCorkPoolBalance + mintAmountNormalized,
                "CorkPoolManager collateral balance should increase"
            );
            ...
            assertEq(
                ...
                initialAllowance - mintAmountNormalized,
                "Allowance should be consumed"
            );
        }
        ...
        assertEq(
            ...
            initialCollateralLocked + mintAmountNormalized,
    ...
    function testFuzz_previewMint(uint8 _collateralDecimal, uint8 _referenceDecimal)
        external
        __createPoolBounded(1 days, _collateralDecimal, _referenceDecimal)
        __giveAssets(bravo)
        __approveAllTokens(bravo, address(corkPoolManager))
    ...
    function test_mint_WithDifferentDecimals()
        external
        __createPool(1 days, 6, 18)
        __giveAssets(bravo)
        __approveAllTokens(bravo, address(corkPoolManager))
