...
contract UnwindExerciseTests is BaseTest {
    ...
    function test_unwindExerciseBasic_ShouldWorkCorrectly()
        external
        __as(alice)
        __depositAndSwap(2 ether, 1 ether, alice)
    {
        ...
        (uint256 expectedCollateralAssetsIn, uint256 expectedRefAssetsOut, uint256 expectedFee) =
            corkPoolManager.previewUnwindExercise(defaultPoolId, desiredCstSharesOut);

        vm.expectEmit(true, true, true, true);
        emit IPoolManager.PoolSwap(
            defaultPoolId, alice, alice, expectedCollateralAssetsIn, expectedRefAssetsOut, 0, 0, true
        );
        ...
        (uint256 collateralAssetsIn, uint256 refAssetsOut, uint256 fee) =
            corkPoolManager.unwindExercise(defaultPoolId, desiredCstSharesOut, alice);
        ...
        assertEq(
            ...
            stateBefore.userSwapToken + desiredCstSharesOut,
        ...
        assertEq(
            ...
            stateBefore.internalState.pool.balances.swapTokenBalance - desiredCstSharesOut,
    ...
    function test_unwindExercise_ShouldWorkWithDifferentOwnerReceiver()
        external
        __as(alice)
        __depositAndSwap(depositAmount, swapAmount, alice)
    {
        ...
        (uint256 collateralAssetsIn, uint256 compensation, uint256 fee) =
            corkPoolManager.unwindExercise(defaultPoolId, desiredCstSharesOut, alice);
    ...
    function test_maxUnwindExercise_ShouldReturnCorrectAmount_WhenLessReferenceAssetThanRespctiveCst()
        external
        __as(alice)
        __depositAndSwap(500 ether, 100 ether, alice)
    {
    ...
    function test_previewUnwindExercise_ShouldReturnCorrectAmounts() external {
        ...
        (uint256 collateralAssetsIn, uint256 referenceAssetsOut, uint256 fee) =
            corkPoolManager.previewUnwindExercise(defaultPoolId, cstSharesOut);
        ...
        __depositAndSwap(depositAmount, swapAmount, alice)
    {
        ...
        (uint256 poolManagerCaAssetsIn, uint256 poolManagerCompensation, uint256 poolManagerFee) =
            corkPoolManager.previewUnwindExercise(defaultPoolId, cstSharesOut);
        (uint256 poolShareCaAssetsIn, uint256 poolShareCompensation, uint256 poolShareFee) =
            swapToken.previewUnwindExercise(cstSharesOut);

        assertEq(
            poolShareCaAssetsIn,
            poolManagerCaAssetsIn,
            "PoolShare previewUnwindExercise sharesIn should match PoolManager previewUnwindExercise"
        );
        assertEq(
            poolShareCompensation,
            poolManagerCompensation,
            "PoolShare previewUnwindExercise compensation should match PoolManager previewUnwindExercise"
        );
        assertEq(
            poolShareFee,
            poolManagerFee,
    ...
    function test_maxUnwindExercise_ShouldReturnZero_AfterExpiry()
        external
        __as(alice)
        __depositAndSwap(2 ether, 1 ether, alice)
    {
    ...
    function test_maxUnwindExercise_ShouldReturnZero_WhenZeroCST()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        uint256 maxShares = corkPoolManager.maxUnwindExercise(defaultPoolId, alice);
        assertEq(maxShares, 0, "Should return 0 when pool has zero cST balance");
    }

    function test_maxUnwindExercise_ShouldReturnZero_WhenZeroReferenceAsset()
        external
        __as(alice)
        __deposit(depositAmount, alice)
    {
        ...
        uint256 poolReferenceBalance = referenceAsset.balanceOf(address(corkPoolManager));

        overridePrank(address(corkPoolManager));
        referenceAsset.transfer(alice, poolReferenceBalance);

        overridePrank(alice);
        uint256 maxShares = corkPoolManager.maxUnwindExercise(defaultPoolId, alice);
        assertEq(maxShares, 0, "Should return 0 when pool has zero reference asset balance");
    }

    // ================================ Negative Test Cases ================================ //

    function test_unwindExercise_ShouldRevert_WhenInsufficientReferenceAssetLiquidity()
        external
        __as(alice)
        __depositAndSwap(400 ether, 200 ether, alice)
    {
        ...
        (uint256 previewCollateralAssetsIn, uint256 previewReferenceAsset,) =
            corkPoolManager.previewUnwindExercise(defaultPoolId, unwindAmount);
    ...
    function test_unwindExercise_ShouldRevert_WhenInsufficientSwapTokenLiquidity()
        external
        __as(alice)
        __depositAndSwap(400 ether, 200 ether, alice)
    {
    ...
    function test_unwindExercise_ShouldRevertAfterExpiry()
        external
        __as(alice)
        __depositAndSwap(2 ether, 1 ether, alice)
    {
    ...
    function test_previewUnwindExercise_ShouldReturnZeroZeroZero_WhenZeroShares()
        external
        __as(alice)
        __depositAndSwap(depositAmount, swapAmount, alice)
    {
        (uint256 assetIn, uint256 fee, uint256 compensationOut) =
            corkPoolManager.previewUnwindExercise(defaultPoolId, 0);

        assertEq(assetIn, 0, "Should return 0 asset in for zero shares");
        assertEq(fee, 0, "Should return 0 fee for zero shares");
        assertEq(compensationOut, 0, "Should return 0 compensation out for zero shares");
    }

    function test_previewUnwindExercise_ShouldReturnZeroZeroZero_WhenUnwindSwapPaused()
        external
        __as(alice)
        __depositAndSwap(depositAmount, swapAmount, alice)
    {
    ...
    function test_previewUnwindExercise_ShouldReturnZeroZeroZero_WhenExpired()
        external
        __as(alice)
        __depositAndSwap(depositAmount, swapAmount, alice)
    {
    ...
    function test_unwindExercise_ShouldRevert_WhenGloballyPaused()
        external
        __as(alice)
        __depositAndSwap(2 ether, 1 ether, alice)
    {
    ...
    function test_unwindExercise_ShouldRevert_WhenInsufficientCollateralAssetBalance()
        external
        __as(alice)
        __depositAndSwap(2 ether, 1 ether, alice)
    {
    ...
    function test_unwindExercise_ShouldRevert_WhenReceiverIsZeroAddress()
        external
        __as(alice)
        __depositAndSwap(2 ether, 1 ether, alice)
    {
    ...
    function testFuzz_unwindExercise_WithDifferentDecimals(uint8 collateralDecimals, uint8 referenceDecimals) external {
        ...
        assertEq(
            ...
            beforeSnapshot.userSwapToken + desiredCstSharesOut,
        ...
        assertEq(
            ...
            beforeSnapshot.internalState.pool.balances.swapTokenBalance - desiredCstSharesOut,
            "Swap token balance should decrease by shares spent"
        );
    ...
    function testFuzz_previewUnwindExercise_WithDifferentDecimals(uint8 collateralDecimals, uint8 referenceDecimals)
        external
    {
        // Bound decimals to reasonable ranges
        collateralDecimals = uint8(bound(collateralDecimals, 6, 18));
        ...
        (uint256 previewCollateralAssetsIn, uint256 previewRefAssetsOut, uint256 previewFee) =
            corkPoolManager.previewUnwindExercise(defaultPoolId, desiredCstSharesOut);
