...
contract SafeMintTests is BaseTest {
    ...
    function test_safeMint_ShouldMintTokens() external __giveAssets(address(corkAdapter)) __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeMint(
            ICorkAdapter.SafeMintParams({
                poolId: defaultPoolId,
                cptAndCstSharesOut: mintAmount,
                receiver: alice,
                maxCollateralAssetsIn: mintAmount,
    ...
    function test_safeMint_ShouldRevert_WhenSlippageExeceed()
        external
        ...
        __as(BUNDLER3_ADDRESS)
    {
        ...
        corkAdapter.safeMint(
            ICorkAdapter.SafeMintParams({
                ...
                cptAndCstSharesOut: mintAmount,
                receiver: alice,
                maxCollateralAssetsIn: mintAmount - 1,
                deadline: block.timestamp
            })
        );
    }
