...
contract SafeWithdrawTests is BaseTest {
    ...
    function setUp() public override {
        ...
        overridePrank(bravo);
        _deposit(defaultPoolId, withdrawAmount, bravo);
    ...
    function test_safeWithdraw_ShouldWithdrawTokensCorrectly() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeWithdraw(
            ICorkAdapter.SafeWithdrawParams({
                poolId: defaultPoolId,
                collateralAssetsOut: withdrawAmount,
        ...
        assertEq(
            ...
            stateBefore.contractCollateral - withdrawAmount,
    ...
    function test_safeWithdraw_ShouldRevert_WhenSlippageExeceed()
        external
        ...
        __as(BUNDLER3_ADDRESS)
    {
        ...
        corkAdapter.safeWithdraw(
            ICorkAdapter.SafeWithdrawParams({
                ...
                owner: address(corkAdapter),
                receiver: alice,
                maxCptSharesIn: withdrawAmount - 1,
                deadline: block.timestamp
            })
        );
    }
