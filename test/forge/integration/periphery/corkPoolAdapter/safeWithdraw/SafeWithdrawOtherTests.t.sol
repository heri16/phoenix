...
contract SafeWithdrawOtherTests is BaseTest {
    ...
    function setUp() public override {
        ...
        _deposit(defaultPoolId, 1000 ether, bravo);
    ...
    function test_safeWithdrawOther_ShouldWithdrawTokensCorrectly() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeWithdrawOther(
            ICorkAdapter.SafeWithdrawOtherParams({
                poolId: defaultPoolId,
                referenceAssetsOut: withdrawAmount,
                owner: address(corkAdapter),
                receiver: alice,
                maxCptSharesIn: withdrawAmount,
    ...
    function test_safeWithdrawOther_ShouldRevert_WhenSlippageExeceed()
        external
        ...
        __as(BUNDLER3_ADDRESS)
    {
        ...
        corkAdapter.safeWithdrawOther(
            ICorkAdapter.SafeWithdrawOtherParams({
                ...
                owner: address(corkAdapter),
                receiver: alice,
                maxCptSharesIn: withdrawAmount / 10,
                deadline: block.timestamp
            })
        );
    }
