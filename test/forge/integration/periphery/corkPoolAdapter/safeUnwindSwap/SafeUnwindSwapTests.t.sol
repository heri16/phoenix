...
contract SafeUnwindSwapTests is BaseTest {
    ...
    function test_safeUnwindSwap_ShouldWorkCorrectly() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeUnwindSwap(
            ICorkAdapter.SafeUnwindSwapParams({
                poolId: defaultPoolId,
                collateralAssetsIn: unwindSwapAmount,
                receiver: alice,
                minCstSharesOut: unwindSwapAmount,
                minReferenceAssetsOut: unwindSwapAmount,
        ...
        assertEq(
            ...
            stateBefore.contractCollateral + unwindSwapAmount,
            "Contract should sent correct amount of collateral assets"
        );
        assertEq(
            stateAfter.contractRef,
            stateBefore.contractRef - unwindSwapAmount,
    ...
    function test_safeUnwindSwap_ShouldRevert_WhenSlippageExeceed()
        external
        ...
        __as(BUNDLER3_ADDRESS)
    {
        ...
        corkAdapter.safeUnwindSwap(
            ICorkAdapter.SafeUnwindSwapParams({
                ...
                collateralAssetsIn: unwindSwapAmount,
                receiver: alice,
                minCstSharesOut: unwindSwapAmount + 1,
        ...
        corkAdapter.safeUnwindSwap(
            ICorkAdapter.SafeUnwindSwapParams({
                ...
                receiver: alice,
                minCstSharesOut: 0,
                minReferenceAssetsOut: unwindSwapAmount + 1,
                deadline: block.timestamp
            })
        );
    }
