...
contract SafeUnwindExerciseOtherTests is BaseTest {
    ...
    function test_safeUnwindExerciseOther_ShouldWorkCorrectly() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeUnwindExerciseOther(
            ICorkAdapter.SafeUnwindExerciseOtherParams({
                poolId: defaultPoolId,
                referenceAssetsOut: unwindExerciseAmount,
                receiver: alice,
    ...
    function test_safeUnwindExerciseOther_ShouldRevert_WhenCalledByNonBundler3() external __as(alice) {
        ...
        corkAdapter.safeUnwindExerciseOther(
            ICorkAdapter.SafeUnwindExerciseOtherParams({
                ...
                receiver: address(0),
                maxCollateralAssetsIn: unwindExerciseAmount,
                minCstSharesOut: unwindExerciseAmount,
                deadline: block.timestamp
            })
        );
    }
    ...
    function test_safeUnwindExerciseOther_ShouldRevert_WhenSlippageExeceed()
        external
        ...
        __as(BUNDLER3_ADDRESS)
    {
        ...
        corkAdapter.safeUnwindExerciseOther(
            ICorkAdapter.SafeUnwindExerciseOtherParams({
                ...
                minCstSharesOut: type(uint256).max,
                deadline: block.timestamp
            })
        );
        ...
        corkAdapter.safeUnwindExerciseOther(
            ICorkAdapter.SafeUnwindExerciseOtherParams({
                ...
                minCstSharesOut: unwindExerciseAmount - 1,
                deadline: block.timestamp
            })
        );
    }
