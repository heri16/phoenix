...
contract SimulateScript is Test {
    ...
    uint256 constant weth_wstETH_OracleRate = 1.192057609 ether;
    uint256 constant wstETH_weETH_OracleRate = 0.8881993472 ether;
    uint256 constant sUSDS_USDe_OracleRate = 0.9689922481 ether;
    uint256 constant sUSDe_USDT_OracleRate = 0.8680142355 ether;
    ...
    function unwindDeposit(MarketObj memory market, MarketId marketId, uint256 swapAmt, address swapToken, address principalToken) public {
        ...
        corkPool.unwindDeposit(marketId, swapAmt, address(this), address(this));
    }
