...
contract SafeUnwindExerciseTests is BaseTest {
    ...
    function test_safeUnwindExercise_ShouldWorkCorrectly() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultPoolId, cstSharesOut: unwindExerciseAmount, receiver: alice, maxCollateralAssetsIn: unwindExerciseAmount, minReferenceAssetsOut: 0, deadline: block.timestamp}));
    ...
    function test_safeUnwindExercise_ShouldRevert_WhenCalledByNonBundler3() external __as(alice) {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultPoolId, cstSharesOut: unwindExerciseAmount, receiver: address(0), maxCollateralAssetsIn: unwindExerciseAmount, minReferenceAssetsOut: unwindExerciseAmount, deadline: block.timestamp}));
    }
    ...
    function test_safeUnwindExercise_ShouldRevert_WhenDeadlinePassed() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultPoolId, cstSharesOut: unwindExerciseAmount, receiver: alice, maxCollateralAssetsIn: unwindExerciseAmount, minReferenceAssetsOut: unwindExerciseAmount, deadline: block.timestamp - 1}));
    }
    ...
    function test_safeUnwindExercise_ShouldRevert_WhenZeroAmount() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultPoolId, cstSharesOut: 0, receiver: alice, maxCollateralAssetsIn: unwindExerciseAmount, minReferenceAssetsOut: unwindExerciseAmount, deadline: block.timestamp}));
    }

    function test_safeUnwindExercise_ShouldRevert_WhenSlippageExeceed() external __giveAssets(address(corkAdapter)) __as(BUNDLER3_ADDRESS) {
        // When maxCollateralAssetsIn is too high
        vm.expectRevert(ErrorsLib.SlippageExceeded.selector);
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultPoolId, cstSharesOut: unwindExerciseAmount, receiver: alice, maxCollateralAssetsIn: unwindExerciseAmount + 1, minReferenceAssetsOut: type(uint256).max, deadline: block.timestamp}));

        // When minReferenceAssetsOut is too low
        vm.expectRevert(ErrorsLib.SlippageExceeded.selector);
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultPoolId, cstSharesOut: unwindExerciseAmount, receiver: alice, maxCollateralAssetsIn: 0, minReferenceAssetsOut: unwindExerciseAmount - 1, deadline: block.timestamp}));
    }
    ...
    function test_safeUnwindExercise_ShouldRevert_WhenExpired() external __as(BUNDLER3_ADDRESS) {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultPoolId, cstSharesOut: unwindExerciseAmount, receiver: alice, maxCollateralAssetsIn: unwindExerciseAmount, minReferenceAssetsOut: unwindExerciseAmount, deadline: block.timestamp}));
    }
