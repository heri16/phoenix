...
/**
 * @title Withdraw Reentrancy Attacker
 * @notice Specific implementation for withdraw reentrancy attacks
 */
contract WithdrawReentrancyAttacker is ReentrancyAttacker {
...
contract WithdrawReentrancyTests is BaseTest {
    ...
    function setUp() public override {
        ...
        attacker = new WithdrawReentrancyAttacker(address(corkPoolManager));
