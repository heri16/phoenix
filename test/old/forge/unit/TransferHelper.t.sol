...
contract TransferHelperTest is Helper {
    ...
    function test_FixedToTokenNativeDecimalsRoundUp() public {
        // with some dust
        uint256 amount = 1e12 + 50;
        uint256 nativeAmount = TransferHelper.normalizeDecimalsWithCeilDiv(amount, 18, 6);
        // should have 2 wei, which will result in a fully backed shares
        vm.assertEq(nativeAmount, 2);
    }
}
