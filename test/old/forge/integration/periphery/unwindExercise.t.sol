...
contract CorkAdapterUnwindExerciseTest is Helper {
    ...
    function test_safeUnwindExercise_success_basicTest() public {
        ...
        defaultCorkController.updateSwapFeePercentage(defaultCurrencyId, 1 ether);
        ...
        (uint256 previewAssetIn, uint256 previewCompensationOut,) = corkPoolManager.previewUnwindExercise(defaultCurrencyId, shares);
        ...
        collateralAsset.transfer(address(corkAdapter), maxAssetsIn);

        uint256 adapterCollateralBefore = collateralAsset.balanceOf(address(corkAdapter));

        // Execute unwind exercise
        vm.expectEmit(true, true, true, true);
        emit IPoolShare.Deposit(address(corkAdapter), RECEIVER, 100 ether, 0);
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultCurrencyId, cstSharesOut: shares, receiver: RECEIVER, minReferenceAssetsOut: minCompensationOut, maxCollateralAssetsIn: maxAssetsIn, deadline: block.timestamp + 1 hours}));

        // Verify results
        uint256 actualCollateralUsed = adapterCollateralBefore - collateralAsset.balanceOf(address(corkAdapter));
    ...
    function test_safeUnwindExercise_revertsOnDeadlineExceeded() public {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultCurrencyId, cstSharesOut: shares, receiver: RECEIVER, minReferenceAssetsOut: minCompensationOut, maxCollateralAssetsIn: maxAssetsIn, deadline: block.timestamp - 1}));
    ...
    function test_safeUnwindExercise_revertsOnZeroReceiver() public {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultCurrencyId, cstSharesOut: shares, receiver: address(0), minReferenceAssetsOut: minCompensationOut, maxCollateralAssetsIn: maxAssetsIn, deadline: block.timestamp + 1 hours}));
    ...
    function test_safeUnwindExercise_revertsOnZeroShares() public {
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultCurrencyId, cstSharesOut: 0, receiver: RECEIVER, minReferenceAssetsOut: minCompensationOut, maxCollateralAssetsIn: maxAssetsIn, deadline: block.timestamp + 1 hours}));
    ...
    function test_safeUnwindExercise_revertsOnSlippageExceeded_maxAssetsIn() public {
        ...
        // Transfer collateral to adapter
        vm.startPrank(DEFAULT_ADDRESS);
        collateralAsset.transfer(address(corkAdapter), 200e18);
        vm.stopPrank();
    ...
    function test_safeUnwindExercise_revertsOnInsufficientCollateral() public {
        ...
        collateralAsset.transfer(address(corkAdapter), 10e18);
    ...
    function test_safeUnwindExercise_success_multipleOperations() public {
        ...
        collateralAsset.transfer(address(corkAdapter), 500e18);
        ...
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultCurrencyId, cstSharesOut: shares1, receiver: RECEIVER, minReferenceAssetsOut: minCompensationOut, maxCollateralAssetsIn: maxAssetsIn, deadline: block.timestamp + 1 hours}));

        // Execute second unwind exercise
        corkAdapter.safeUnwindExercise(ICorkAdapter.SafeUnwindExerciseParams({poolId: defaultCurrencyId, cstSharesOut: shares2, receiver: RECEIVER, minReferenceAssetsOut: minCompensationOut, maxCollateralAssetsIn: maxAssetsIn, deadline: block.timestamp + 1 hours}));
