...
contract CorkAdapterTest is Helper {
    ...
    function test_mint_success_18decimals() public {
        ...
        collateralAsset.transfer(address(corkAdapter), INITIAL_BALANCE);

        uint256 peripheryBalanceBefore = collateralAsset.balanceOf(address(corkAdapter));
        ...
        corkAdapter.safeMint(ICorkAdapter.SafeMintParams({poolId: defaultCurrencyId, cptAndCstSharesOut: shares, receiver: RECEIVER, maxCollateralAssetsIn: type(uint256).max, deadline: block.timestamp}));

        uint256 peripheryBalanceAfter = collateralAsset.balanceOf(address(corkAdapter));
    ...
    function testFuzz_mint_differentDecimals(uint8 raDecimals, uint8 paDecimals, uint256 shares) public {
        ...
        uint256 receiverDSBefore = swapToken.balanceOf(RECEIVER);
        uint256 receiverCollateralBefore = collateralAsset.balanceOf(RECEIVER);
        uint256 corkBalanceBefore = collateralAsset.balanceOf(address(corkPoolManager));
        ...
        uint256 receiverDSAfter = swapToken.balanceOf(RECEIVER);
        uint256 receiverCollateralAfter = collateralAsset.balanceOf(RECEIVER);
        uint256 corkBalanceAfter = collateralAsset.balanceOf(address(corkPoolManager));
    ...
    function test_mint_revertsOnZeroReceiver() public {
        ...
        corkAdapter.safeMint(ICorkAdapter.SafeMintParams({poolId: defaultCurrencyId, cptAndCstSharesOut: 100e18, receiver: address(0), maxCollateralAssetsIn: type(uint256).max, deadline: block.timestamp}));
    ...
    function test_mint_revertsOnZeroShares() public {
        ...
        corkAdapter.safeMint(ICorkAdapter.SafeMintParams({poolId: defaultCurrencyId, cptAndCstSharesOut: 0, receiver: RECEIVER, maxCollateralAssetsIn: type(uint256).max, deadline: block.timestamp}));
    ...
    function test_mint_revertsOnUnauthorizedCaller() public {
        ...
        corkAdapter.safeMint(ICorkAdapter.SafeMintParams({poolId: defaultCurrencyId, cptAndCstSharesOut: 100e18, receiver: RECEIVER, maxCollateralAssetsIn: type(uint256).max, deadline: block.timestamp}));
    }
    ...
    function test_deposit_success_18decimals() public {
        ...
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: assets, receiver: RECEIVER, minCptAndCstSharesOut: 0, deadline: block.timestamp}));
    ...
    function test_deposit_maxAmount() public {
        ...
        collateralAsset.transfer(address(corkAdapter), mintAmount);
        ...
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: mintAmount, receiver: RECEIVER, minCptAndCstSharesOut: 0, deadline: block.timestamp}));
    ...
    function testFuzz_deposit_maxAmountDifferentDecimals(uint8 raDecimals, uint8 paDecimals) public {
        ...
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: transferAmount, receiver: RECEIVER, minCptAndCstSharesOut: 0, deadline: block.timestamp}));
    ...
    function test_mint_revertsOnExpiredDeadline() public {
        ...
        corkAdapter.safeMint(ICorkAdapter.SafeMintParams({poolId: defaultCurrencyId, cptAndCstSharesOut: 100e18, receiver: RECEIVER, maxCollateralAssetsIn: type(uint256).max, deadline: block.timestamp - 1}));
    ...
    function test_mint_revertsOnSlippageExceeded() public {
        ...
        corkAdapter.safeMint(ICorkAdapter.SafeMintParams({poolId: defaultCurrencyId, cptAndCstSharesOut: shares, receiver: RECEIVER, maxCollateralAssetsIn: maxAssetsIn, deadline: block.timestamp}));
    ...
    function test_deposit_revertsOnZeroReceiver() public {
        ...
        vm.expectRevert(ErrorsLib.ZeroAddress.selector);
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: 100e18, receiver: address(0), minCptAndCstSharesOut: 0, deadline: block.timestamp}));
    ...
    function test_deposit_revertsOnZeroAmount() public {
        ...
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: 0, receiver: RECEIVER, minCptAndCstSharesOut: 0, deadline: block.timestamp}));
    ...
    function test_deposit_revertsOnUnauthorizedCaller() public {
        ...
        vm.prank(address(0x999));
        vm.expectRevert(ErrorsLib.UnauthorizedSender.selector);
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: 100e18, receiver: RECEIVER, minCptAndCstSharesOut: 0, deadline: block.timestamp}));
    }
    ...
    function test_deposit_revertsOnSlippageExceeded() public {
        ...
        vm.expectRevert(ErrorsLib.SlippageExceeded.selector);
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: assets, receiver: RECEIVER, minCptAndCstSharesOut: minSharesOut, deadline: block.timestamp}));
    ...
    function test_deposit_revertsOnExpiredDeadline() public {
        ...
        vm.expectRevert(ErrorsLib.DeadlineExceeded.selector);
        corkAdapter.safeDeposit(ICorkAdapter.SafeDepositParams({poolId: defaultCurrencyId, collateralAssetsIn: 100e18, receiver: RECEIVER, minCptAndCstSharesOut: 0, deadline: block.timestamp - 1}));
